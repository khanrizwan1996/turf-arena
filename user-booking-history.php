                            ...
                            <div class="table-responsive">
                                <table id="resultsTable" class="table table-striped table-bordered nowrap"
                                    ...
                                    <tbody>
                                        <?php 
                                        $i=1;
                                        $getAllTodayBookingByUser	= $venuesBookingObj->getAllBookingHistoryByUserId($sessionUserId);
                                        foreach($getAllTodayBookingByUser as $getAllTodayBookingByUserRow){

                                            $getConfirmedVenueBookingBySlots = $venuesBookingObj->getConfirmedVenueBookingBySlotsId($getAllTodayBookingByUserRow['vnub_venue_id'], $getAllTodayBookingByUserRow['vnus_id'],$getAllTodayBookingByUserRow['vnub_slot_date']);
