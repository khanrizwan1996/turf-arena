<?php require('vender-header-content.php'); ?>
<!doctype html>
...
<head>
	...
	<link rel="stylesheet" href="<?= VENDER_HOST_URL ?>assets/css/dark-theme.css" />
	<link rel="stylesheet" href="<?= VENDER_HOST_URL ?>assets/css/semi-dark.css" />
	<link rel="stylesheet" href="<?= VENDER_HOST_URL ?>assets/css/header-colors.css" />
	...
	<div class="wrapper">
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="<?= VENDER_HOST_URL ?>assets/images/logo-icon.png" class="logo-icon" alt="logo icon">
				</div>
				<div>
				...
				<nav class="navbar navbar-expand gap-3">
									  ...
									  <div class="row gx-0 gy-2 row-cols-3 justify-content-center p-2">
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/slack.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/behance.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												<img src="<?= VENDER_HOST_URL ?>assets/images/app/google-drive.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/outlook.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/github.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/stack-overflow.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/figma.png" width="30" alt="">
											  </div>
											  <div class="app-name">
												  <p class="mb-0 mt-1">Stack</p>
											  </div>
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/twitter.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/google-calendar.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/spotify.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/google-photos.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/pinterest.png" width="30" alt="">
											  </div>
											  <div class="app-name">
												  <p class="mb-0 mt-1">Photos</p>
											  </div>
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/linkedin.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/dribble.png" width="30" alt="">
											  </div>
											  <div class="app-name">
												  <p class="mb-0 mt-1">Dribble</p>
											  </div>
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/youtube.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/google.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/envato.png" width="30" alt="">
											  </div>
											  <div class="app-name">
										 ...
										 <div class="col">
										  <a href="javascript:;">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="<?= VENDER_HOST_URL ?>assets/images/app/safari.png" width="30" alt="">
											  </div>
											  <div class="app-name">
								...
								<div class="dropdown-menu dropdown-menu-end">
									...
									<div class="header-notifications-list">
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="<?= VENDER_HOST_URL ?>assets/images/avatars/avatar-1.png" class="msg-avatar" alt="user avatar">
												</div>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="<?= VENDER_HOST_URL ?>assets/images/avatars/avatar-2.png" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="notify bg-light-success text-success">
													<img src="<?= VENDER_HOST_URL ?>assets/images/app/outlook.png" width="25" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="<?= VENDER_HOST_URL ?>assets/images/avatars/avatar-4.png" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="notify bg-light-primary">
													<img src="<?= VENDER_HOST_URL ?>assets/images/app/github.png" width="25" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="<?= VENDER_HOST_URL ?>assets/images/avatars/avatar-8.png" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
									...
									<div class="header-message-list">
											...
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="<?= VENDER_HOST_URL ?>assets/images/products/11.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="<?= VENDER_HOST_URL ?>assets/images/products/02.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="<?= VENDER_HOST_URL ?>assets/images/products/03.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="<?= VENDER_HOST_URL ?>assets/images/products/04.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="<?= VENDER_HOST_URL ?>assets/images/products/05.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="<?= VENDER_HOST_URL ?>assets/images/products/06.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="<?= VENDER_HOST_URL ?>assets/images/products/07.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="<?= VENDER_HOST_URL ?>assets/images/products/08.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="<?= VENDER_HOST_URL ?>assets/images/products/09.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="<?= VENDER_HOST_URL ?>assets/images/avatars/avatar-2.png" class="user-img" alt="user avatar">
							<div class="user-info">
