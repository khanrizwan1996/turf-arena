...
$getAllVenueSlots = $venuesObj->getVenueSearch($_POST['search'],$_POST['filter_by']);
if (!empty($getAllVenueSlots) && count($getAllVenueSlots) > 0) {
    print_r($getAllVenueSlots);
} else {
    echo "no data found";
}
}
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="title__head-v2">
                        <br><br><br>
                        <h2 class="text-capitalize">Venues Of <?= $getAllVenuesCityRow['vnu_city'] ?></h2>
                        <p class="text-capitalize">Book Your Favorites Slots Now</p>
                    </div>
                </div>
            </div>
            ...
            <div class="recent__property-carousel owl-carousel owl-theme">
                <?php 
                    $getAllVenuesByCityName = $venuesObj->getAllVenuesByCityName($getAllVenuesCityRow['vnu_city']);
                    foreach($getAllVenuesByCityName as $getAllVenuesByCityNameRow){
                        $venueName = str_replace(' ', '-', $getAllVenuesByCityNameRow['vnu_name']);
                        $getTotalSlotCount = $venuesSlotsObj->getTotalSlotCountByVenueId($getAllVenuesCityRow['vnu_id']);
				?>
                <div class="item">
                    <a href="<?= HOST_URL."venue-detail/".$venueName ?>">
                            ...
                            <div class="card__image-hover-overlay">
                                ...
                                <div class="card__image-content">
                                    <div class="card__image-content-desc">
                                        <h6> <?= $getAllVenuesByCityNameRow['vnu_name'] ?></h6>
                                        <p class="mb-0"><i class="fa fa-map-marker"></i> <?= $getAllVenuesByCityNameRow['vnu_area']?></p>
                                    </div>
                                    <ul class="list-inline card__hidden-content">
                                        <li class="list-inline-item">
                                            <span style="margin-top: 5px;">Total Slots: <?= $getTotalSlotCount ?></span>
                                        </li>
                                        <li class="list-inline-item">
                                            <span style="margin-top: 5px;">View Details</span>
                                        </li>
                                    </ul>
                                </div>
                                <img alt="" src="<?= VENUES_IMAGES_URL.$getAllVenuesByCityNameRow['vnu_image']; ?>" class="img-fluid h-40 ">
                            </div>
                        </div>
                    </a>
                </div>
